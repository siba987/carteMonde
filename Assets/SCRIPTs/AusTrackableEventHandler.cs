...
/// </summary>
public class AusTrackableEventHandler : MonoBehaviour, ITrackableEventHandler
{
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        Debug.Log("Trackable " + mTrackableBehaviour.TrackableName + " found");
        if ((mTrackableBehaviour.TrackableName == "australia0") || 
            (mTrackableBehaviour.TrackableName == "australia1") ||
            (mTrackableBehaviour.TrackableName == "australia2") ||
            (mTrackableBehaviour.TrackableName == "australia3") ||
            (mTrackableBehaviour.TrackableName == "australia4")){
            Debug.Log(">>> inside B0 ");
            EnableItem();        
        }
    }
